...
${CountryOriginDrop}  //select[@placeholder='Country of Origin...*']
${CountryOriginSelection}  /select[@id='country']//option[contains(text(),'Afghanistan')]
${ProcessingCountryDrop}  //select[@id='processing']
${ProcessingCountrySelection}  //select[@id='processing']//option[contains(text(),'Afghanistan')]
...
${SeaLifeCatSelection}  //option[@class='ng-star-inserted'][contains(text(),'Fish')]
...
${CoProdSKUField}  //label[contains(.,'Company Product SKU...')]
${CoHsCodeField}  //label[contains(.,'HS Code...')]
${CoHsCodeLookup}  //a[contains(.,'Find Code')]
${MinOrderField}  //label[@for='min'][contains(.,'Minimum Order...')]
${MaxOrderField}  //input[@ng-reflect-name='maximumorder']
