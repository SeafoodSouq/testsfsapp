...
#    SSouqSmoke.Navigate to Page  https://dev.seafoodsouq.com
#    SSouqSmoke.Existing User Login  ron@seafoodsouq.com    Test1234
...
#    SSouqSmoke.Buyer Registration  Hello    World    BuySeafoodIEEE@seafoodsouq.com   0504567890   Test1234    Test1234    TestCompany   FishMarket    Warehouse 10, 58 St    21
#
#Seller Registration
#    Log To Console  Sell
#    SSouqSmoke.Navigate to Page  https://qa.seafoodsouq.com
#    SSouqSmoke.Seller Registration  Hello  World  SellerRonHH@seafoodsouq.com   (201) 555-1212   Test1234    Test1234     Seller Test Co    4    RonTest    Brooklyn    101 Jefferson Ave    Salmon, Cod, Sardines    212    1234    12342    12


Add Product
    Log To Console  Add Product
    SSouqSmoke.Navigate to Page  https://qa.seafoodsouq.com
    SSouqSmoke.Existing User Login   SellerRon1@seafoodsouq.com   Test1234
